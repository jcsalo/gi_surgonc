...
\hypertarget{part-colon-cancer-cancer}{%
\part*{Colon Cancer Cancer}\label{part-colon-cancer-cancer}}
\addcontentsline{toc}{part}{Colon Cancer Cancer}
...
\hypertarget{colon-cancer}{%
\chapter{Colon Cancer}\label{colon-cancer}}

\hypertarget{neoadjuvant-chemotherapy-for-colon-cancer}{%
\section{Neoadjuvant Chemotherapy for colon cancer}\label{neoadjuvant-chemotherapy-for-colon-cancer}}

Seymour MT, Morton D. FOxTROT: an international randomised controlled trial in 1052 patients (pts) evaluating neoadjuvant chemotherapy (NAC) for colon cancer. J Clin Oncol. 2019 May;37(15 Suppl):3504-3504.

\hypertarget{extended-node-dissection-for-colon-cancer}{%
\section{Extended Node dissection for colon cancer}\label{extended-node-dissection-for-colon-cancer}}
