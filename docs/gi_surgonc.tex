...
\hypertarget{ge-junction-classification}{%
\section{GE junction classification}\label{ge-junction-classification}}

GE junction adenocarcioma is classified according to Siewert

\includegraphics{images/siewert.png}
\includegraphics[width=0.3125in,height=0.20833in]{images/siewert.png}
\includegraphics[width=0.5\textwidth,height=0.5\textheight]{images/siewert.png}
...
\hypertarget{gastric-carcinoids}{%
\chapter{Gastric Carcinoids}\label{gastric-carcinoids}}
...
\hypertarget{gi-stromal-tumors}{%
\chapter{GI Stromal Tumors}\label{gi-stromal-tumors}}

Endoscopic surveillance for gastric GISTA less than 2cm in size.

\hypertarget{part-colorectal-cancer}{%
\part*{Colorectal Cancer}\label{part-colorectal-cancer}}
\addcontentsline{toc}{part}{Colorectal Cancer}

\textbf{Resources}

\href{https://fascrs.org/ascrs/media/files/downloads/2022-Colon-Cancer-CPG.pdf}{ACSRS Guidlines}
...
PET is not recommended routinely for evaluation of colon cancer.\citep{you1911}
...
\hypertarget{rectal-cancer}{%
\chapter{Rectal Cancer}\label{rectal-cancer}}
